...
const MyComponent = ({title, description,imageName })=> {
  return (
    ...
    <div href="#" className="group relative block h-64 sm:h-80 lg:h-96">
      ...
      <div
        className="relative flex h-full transform items-end border-2 border-black bg-white transition-transform group-hover:-translate-x-2 group-hover:-translate-y-2 active:group-hover:-translate-x-2 active:group-hover:-translate-y-2"
      >
